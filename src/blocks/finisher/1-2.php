...
function u24web_render_finisher_1_2_block( $attributes, $content ) {
    ...
    $body='';
     ...
     $author_name = get_the_author_meta('display_name', $author_id); // Fetching author's name
     $author_description = get_the_author_meta('description', $author_id); // Fetching author's description 
    ...
    <div class="swiper-slide  u24swiper-top__slide h-auto pb-3" >
        <article class="card h-100 border-0 shadow-sm ">
            <div class="position-relative rounded-2 overflow-hidden w-100 h-100">
                ...
                <a href="'.get_the_permalink().'" class="btn btn-icon btn-light bg-white border-white btn-sm rounded-circle position-absolute top-0 end-0 zindex-5 me-3 mt-3" data-bs-toggle="tooltip" data-bs-placement="left">
                ...
                <div class="position-absolute w-100 bottom-0">
                    ...
                    <div class="card-footer py-4 d-none d-md-block">
                        ...
                        <a href="'.get_the_permalink().'" class="d-flex align-items-center text-decoration-none">
                            <img src="'.$author_image_url.'" class="rounded-circle" width="48" alt="Avatar">
                            <div class="ps-3">
                            <h6 class="fs-base fw-semibold mb-0 text-light">'.$author_name.'</h6>  
                            <span class="fs-sm text-muted">'.$author_description.'</span>
                            </div>
                        </a>
                    </div>
                </div>
